...
from bert_models.base_bert_model_meta_model_with_window_all import BaseBertModelMetaModel
...
class StudyTypeLabeler(BaseBertModelMetaModel):
    ...
    def __init__(self, output_dir, label_list = list(StudyTypeLabels.STUDY_TYPE_LABEL_TO_NUMBER.values()),
            ...
            label_column = "label", use_concat_results = False, meta_model_folder = "",
            use_one_layer = True, keep_prob=0.9, epochs_num=1, multilabel=False):
        BaseBertModelMetaModel.__init__(self, output_dir, label_list, gpu_device_num_hub=gpu_device_num_hub, 
            ...
            use_concat_results=use_concat_results, meta_model_folder = meta_model_folder,
            use_one_layer = use_one_layer, keep_prob=keep_prob, epochs_num=epochs_num, multilabel=multilabel)
